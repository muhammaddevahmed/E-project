                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#detailsModal<?php echo $payment['payment_id'] ?>">
                                    View
                                </button>
                            </td>
                            <td>
                                ...
                                <form method="post" class="d-inline">
                                    ...
                                    <button type="submit" name="update_status" class="btn btn-sm btn-danger">Decline</button>
                                </form>
                                <?php } else { ?>
                        ...
                        <!-- Details Modal -->
                        <div class="modal fade" id="detailsModal<?php echo $payment['payment_id'] ?>" tabindex="-1" aria-labelledby="detailsModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p>
                                                    <strong>Name:</strong> <?php echo htmlspecialchars($payment['first_name'] . ' ' . $payment['last_name']) ?><br>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p>
                                                    ...
                                                    <strong>Date:</strong> <?php echo date('M d, Y h:i A', strtotime($payment['payment_date'])) ?><br>
                                                    <strong>Status:</strong> <span class="badge <?php echo $status_class ?>"><?php echo ucfirst($payment['payment_status']) ?></span>
                                                </p>
