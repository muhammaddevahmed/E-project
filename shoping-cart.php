            ...
            <div class="col-lg-12">
                ...
                <div class="shoping__cart__table">
                    <form action="shoping-cart.php" method="POST">
                                    ...
                                    <td>
                                        <div class="quantity">
                                            <button type="button" class="qty-btn dec"
                                                data-id="<?php echo $product_id; ?>">-</button>
                                            <input type="text" name="quantity[<?php echo $product_id; ?>]"
                                                class="qty-input" data-id="<?php echo $product_id; ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <button type="submit" name="update_cart" class="primary-btn cart-btn cart-btn-right">
                                    Update Cart
                                </button>
                            </div>
                        </div>
